...
This is a README describing a big data analytics research project on price optimization depending on the time of year using Python. It will contain the abstract, literature review, the overall methodology, descriptive statistics, model evaulation, conclusion, related works, and references. The .IPYNB File will contain the code, supporting visualizations and model output results.
